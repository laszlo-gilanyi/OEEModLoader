...
namespace Siccity.GLTFUtility {
	...
	/* [Preserve removed for IL2CPP build] */ public class GLTFMaterial {
#if UNITY_EDITOR
		...
		/* [Preserve removed for IL2CPP build] */ public class Extensions {
		...
		/* [Preserve removed for IL2CPP build] */ public class PbrMetalRoughness {
		...
		/* [Preserve removed for IL2CPP build] */ public class PbrSpecularGlossiness {
		...
		/* [Preserve removed for IL2CPP build] */ public class TextureInfo {
