...
namespace Siccity.GLTFUtility {
	...
	/* [Preserve removed for IL2CPP build] */ public class GLTFAnimation {
...
#region Classes
		...
		/* [Preserve removed for IL2CPP build] */ public class Sampler {
		...
		/// <summary> Connects the output values of the key frame animation to a specific node in the hierarchy </summary>
		/* [Preserve removed for IL2CPP build] */ public class Channel {
		...
		/* [Preserve removed for IL2CPP build] */ public class Target {
		...
		/* [Preserve removed for IL2CPP build] */ public class ImportResult {
			...
			for (int i = 0; i < channels.Length; i++) {
				...
				switch (channel.target.path) {
					case "translation":
						...
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localPosition.x", posX);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localPosition.y", posY);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localPosition.z", posZ);
						break;
					case "rotation":
						...
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localRotation.x", rotX);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localRotation.y", rotY);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localRotation.z", rotZ);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localRotation.w", rotW);
						break;
					case "scale":
						...
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localScale.x", scaleX);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localScale.y", scaleY);
						result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<Transform>(), "localScale.z", scaleZ);
						break;
					case "weights":
						...
						for(int j = 0; j < numberOfBlendShapes; ++j) {
							...
							result.clip.SetCurve(relativePath, Il2CppInterop.Runtime.Il2CppType.Of<SkinnedMeshRenderer>(), propertyName, blendShapeCurves[j]);
						}
						break;
				}
			}
...
#pragma warning disable CS0618
			// The IL2CPP-wrapped Keyframe exposes the four-arg
			// (time, value, inTangent, outTangent) constructor. The optional 5th
			// and 6th weight args from desktop Unity are unavailable here, so we
			// drop them; weighted tangents are not used for the LINEAR / STEP /
			// CUBICSPLINE interpolations we emit.
			if (interpolationMode == InterpolationMode.STEP) {
				keyframe = new Keyframe(time, getValue(valueArray[index]), float.PositiveInfinity, float.PositiveInfinity);
				...
				keyframe = new Keyframe(time, getValue(valueArray[(index * 3) + 1]), inTangent, outTangent);
			} else { // LINEAR
				keyframe = new Keyframe(time, getValue(valueArray[index]), 0, 0);
			}
