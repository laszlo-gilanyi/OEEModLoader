...
namespace Siccity.GLTFUtility {
	...
	/* [Preserve removed for IL2CPP build] */ public class GLTFAccessor {
#region Serialized fields
		...
		/* [Preserve removed for IL2CPP build] */ public class Sparse {
			[JsonProperty(Required = Required.Always)] public int count;
			...
			/* [Preserve removed for IL2CPP build] */ public class Values {
			...
			/* [Preserve removed for IL2CPP build] */ public class Indices {
				[JsonProperty(Required = Required.Always)] public int bufferView;
				[JsonProperty(Required = Required.Always)] public GLType componentType;
				public int byteOffset = 0;
			}
