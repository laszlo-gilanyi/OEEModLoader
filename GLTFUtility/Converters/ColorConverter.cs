...
namespace Siccity.GLTFUtility.Converters {
	...
	/* [Preserve removed for IL2CPP build] */ public class ColorRGBConverter : JsonConverter {
	...
	/* [Preserve removed for IL2CPP build] */ public class ColorRGBAConverter : JsonConverter {
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer) {
			Color c = (Color) value;
			writer.WriteStartArray();
			writer.WriteValue(c.r);
